...
destination = "/Users/megansears/Documents/MRMS/SPR/2022"

date = start

while date <= end:
    url = "http://mtarchive.geol.iastate.edu/{:04d}/{:02d}/{:02d}/mrms/ncep/PrecipRate/PrecipRate_00.00_{:04d}{:02d}{:02d}-{:02d}0000.grib2.gz".format(
