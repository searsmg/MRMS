...
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220823-220000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
# 2022-08-23 14:00
#pull in an example raster -- add 7 hrs
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220823-230000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
# 2022-08-23 15:00
#pull in an example raster -- add 7 hrs
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220824-000000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
# 2022-08-23 16:00
#pull in an example raster -- add 7 hrs
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220824-010000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
#pull in an example raster -- add 7 hrs
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220731-180000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
# 2022-07-31 12:00
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220731-190000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
# 2022-07-31 13:00
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220731-200000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
# 2022-07-31 14:00
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220731-210000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
# 2022-07-31 15:00
r <- rast('/Volumes/CameronPeakFire/MRMS_2022/RadarOnly_QPE_01H_00.00_20220731-220000.grib2') %>%
  terra::project(., 'EPSG:26913')
...
# Comparing tipping bucket to MRMS MI60s and total P
...
uw_glm <- glm(response ~ q_cms + doy + duration_hr + MI60 + P, data = uw_response2, family = binomial)
